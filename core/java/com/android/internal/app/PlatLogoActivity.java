...
public class PlatLogoActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIsStatic = getIntent().hasExtra("is_static");
        ...
        logo.setImageResource(mIsStatic
        ...
        letter.setTextSize(mIsStatic ? 150 : 300);
        letter.setTextColor(0xFFFFFFFF);
        letter.setGravity(Gravity.CENTER);
        letter.setText(mIsStatic ? "Sr" : "K");

        String cmVersion = SystemProperties.get("ro.static.version");
        if (cmVersion != null) {
        ...
        tv.setText(mIsStatic ? "Static " + staticVersion : "ANDROID " + Build.VERSION.RELEASE);
